      ...
      >
        {navItems.map((navItem: any, idx: number) => (
          <a
            ...
            href={navItem.link}
            className={cn(
              "relative dark:text-neutral-50 items-center flex space-x-1 text-neutral-600 dark:hover:text-amber-500 hover:text-amber-500 transition-colors"
            )}
          >
        ...
        <button className="border text-sm font-medium relative border-neutral-200 dark:border-white/[0.2] text-black dark:text-white px-4 py-2 rounded-full hover:bg-amber-500 hover:text-black transition-colors">
          <span>Contato</span>
